...
public strictfp class Range implements Serializable {
    ...
    public static Range combineIgnoringNaN(Range range1, Range range2) {
        ...
        double l = min(min(range1.getUpperBound(), range2.getUpperBound()), min(range1.getLowerBound(), range2.getLowerBound()));
        double u = max(max(range1.getUpperBound(), range2.getUpperBound()), max(range2.getLowerBound(), range2.getLowerBound()));
